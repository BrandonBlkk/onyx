...
const passwordResetEmail = async ({ resetLink, fullname, supportEmail = process.env.SUPPORT_EMAIL || 'support@onyx.com' }) => {
              ...
              <tr>
                <td style="padding: 40px 36px 32px 36px;">
                  ...
                  <p style="margin: 0 0 28px 0; font-size: 15px; line-height: 24px; color: #52525b;">
                    We received a request to reset the password for your Onyx account. Click the button below to choose a new one:
                  </p>
                  ...
                  <table border="0" cellpadding="0" cellspacing="0" width="100%" role="presentation" style="margin-bottom: 32px;">
                    <tr>
                      <td align="left">
                        <div>
                          <!--[if mso]>
                          <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="${resetLink}" style="height:44px;v-text-anchor:middle;width:160px;" arcsize="18%" stroke="f" fillcolor="#09090b">
                            <w:anchorlock/>
                            <center style="color:#ffffff;font-family:sans-serif;font-size:14px;font-weight:600;">Reset Password</center>
                          </v:roundrect>
                          <![endif]-->
                          <!--[if !mso]><!-->
                          <a href="${resetLink}" target="_blank" style="display: inline-block; padding: 12px 28px; background-color: #09090b; color: #ffffff; text-decoration: none; font-weight: 600; font-size: 14px; line-height: 20px; text-align: center;">Reset Password &rarr;</a>
                          <!--<![endif]-->
                        </div>
                      </td>
                    </tr>
                  ...
                  <p style="margin: 0 0 12px 0; font-size: 13px; line-height: 20px; color: #71717a;">
                    This link is valid for <strong>15 minutes</strong>. If you didn’t request a reset, you can safely ignore this email—your password won't change.
                  </p>

                  <p style="margin: 0 0 28px 0; font-size: 13px; line-height: 20px; color: #71717a;">
                    For your security, never share this link with anyone. If you have questions, contact our support team at <a href="mailto:${supportEmail}" style="color: #2563eb; text-decoration: underline;">${supportEmail}</a>.
                  </p>

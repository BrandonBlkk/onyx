      ...
      <div className="mx-auto max-w-6xl px-6">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl font-bold tracking-tight text-zinc-100 mb-4">
            ...
            <span className={headingGradientClass}>nothing you don't.</span>
          </h2>
        ...
        >
          {features.map((feature, i) => (
            <motion.div
              ...
              className="group relative rounded-2xl border border-zinc-800/80 bg-zinc-900/50 p-6 sm:p-8 transition-all duration-300 hover:border-zinc-700/80 hover:bg-zinc-900/80"
              id={`feature-card-${i}`}
            >
              <div className="absolute inset-0 rounded-2xl bg-accent-500/2 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <div className="relative z-10">
                <div className="flex items-center justify-between mb-5">
                  <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-zinc-800 border border-zinc-700/50 text-teal-600 group-hover:border-accent-500/30 transition-colors">
                    {feature.icon}
                  </div>
                  <span className="text-[10px] font-medium uppercase tracking-widest text-zinc-500 bg-zinc-800/60 px-2.5 py-1 rounded-full">
                    {feature.tag}
                  </span>
                </div>
